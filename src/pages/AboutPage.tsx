        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-gray-800 rounded-lg shadow-xl overflow-hidden mb-12">
            <div className="p-8">
              ...
              The Aswang Archive is committed to exploring and safeguarding the vibrant myths and folk tales of the Philippines. Our mission is to create an in-depth collection for enthusiasts, scholars, and curious minds eager to discover the supernatural beings, age-old stories, and cultural practices that shape the Philippines' unique heritage.

              By combining thorough research, engaging narratives, and insights from local communities, we strive to ensure these timeless legends endure for generations to come while introducing them to audiences worldwide.
              </p>
